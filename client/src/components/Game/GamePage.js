...
function GamePage({}) {
    ...
    useEffect(() => {
        ...
        if (challengeId){
                ...
                .then(resp => resp.json())
                .then(data => {
                    // console.log("im fetching from the challenge")
                    setChallenge(data)
            ...
            // console.log("im setting things no challenge")
            //TODO: this is super poorly done
    ...
    return (
        <div id="game-page">
                ...
                <div id='setting-and-control'>
                    ...
                    {gameStarted ? 
                        ...
                        <div id="current-settings">
                            ...
                            { challengeId ? <p>You can't change challenge settings</p> : <button onClick={openModal}>Change settings?</button>}
                        </div> 
                        <button onClick={openChallengeModal}>{challengeId ? 'Choose a different challenge?' : 'Play a challenge instead of random?'}</button>
                        </>
                    }
                    {/* </div> */}
            ...
            {/* <div id='goal-and-canvas'> */}
                ...
                >
                    <GameCanvas setDrawingData={setDrawingData} gameActive={gameActive} canvasRef={canvasRef} />
                </div>
            {/* </div> */}
            </div>
            <Footer />
